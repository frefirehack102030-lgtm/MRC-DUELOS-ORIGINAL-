...
--// ESP PLAYERS VERMELHO(INCLUYE INVISIBLES)
...
local function createESP(plr)
	...
	hitbox.Color3 = Color3.fromRGB(255,50,50)
...
activateStroke.Color = Color3.fromRGB(255,50,50)
...
activate.MouseButton1Click:Connect(function()
    ...
    if active then
        ...
        activate.BackgroundColor3 = Color3.fromRGB(255,50,50)
...
--// MRC Duels - RADIO CUADRADO ACOTADO SUBIDO (Y = -2.5)
...
strokeTop.Color = Color3.fromRGB(255,50,50)
...
topLabel.TextColor3 = Color3.fromRGB(255,50,50)
...
RunService.RenderStepped:Connect(function()
    ...
    topLabel.Text = "MRC Duels| "..fps.." FPS | "..ping.." ms"
end)
...
strokeHub.Color = Color3.fromRGB(255,50,50)
...
local function ShowSection(sectionName)
    ...
    for _,b in pairs(sectionButtons) do
        if b.Text == sectionName then b.BackgroundColor3 = Color3.fromRGB(255,50,50) end
    end
end
...
local function CreateToggle(sectionName,text)
    ...
    if text == "Radio Steal Nearest" and sectionName == "Settings" then
        ...
        Instance.new("UIStroke", textbox).Color = Color3.fromRGB(255,50,50)
    ...
    button.MouseButton1Click:Connect(function()
        enabled = not enabled
        if enabled then
            TweenService:Create(button, TweenInfo.new(0.25), {BackgroundColor3 = Color3.fromRGB(255,50,50)}):Play()
